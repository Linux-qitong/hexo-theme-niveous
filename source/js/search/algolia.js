document.addEventListener("DOMContentLoaded", function () {
    ...
    const pagination = instantsearch.widgets.pagination({
        ...
        showFirstLast: false,
        templates: {
            first: '<i class="niveous fas fa-angles-left"></i>',
            last: '<i class="niveous fas fa-angles-right"></i>',
            previous: '<i class="niveous fas fa-angle-left"></i>',
            next: '<i class="niveous fas fa-angle-right"></i>',
        },
        cssClasses: {
            root: "pagination",
