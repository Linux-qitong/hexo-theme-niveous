...
const addHighlight = () => {
  ...
  const copyEle = copy
    ? `<i class="niveous fas fa-copy copy-button"></i>`
    : "<i></i>";
  const expandEle = `<i class="niveous fas fa-angle-down expand"></i>`;
  const limitEle = limit
    ? `<i class="niveous fas fa-angles-down"></i>`
    : "<i></i>";
...
class tabs {
  ...
  static expireAddListener() {
    ...
    ele.innerHTML = `<i class="niveous fas fa-circle-exclamation"></i>${
      expire.text_prev
